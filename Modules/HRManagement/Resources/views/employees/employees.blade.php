                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="re_employees_table">
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-50px">Personal Email</th>
                                    <th class="min-w-50px">Company Phone</th>
                                    <th class="min-w-50px">Personal Phone</th>
                                    <th class="min-w-50px">Location</th>
                                    <th class="min-w-50px">Hire Date</th>
                                    <th class="min-w-50px">Employment Type</th>
...
{{--                                                <span>{{$deduction->employee->company_email_address}}</span>--}}
                                        ...
                                        <!--end::Name=-->
                                        <td>
                                            {{ $employee->company_email_address }}
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <!--begin::Update-->
                                            @can("edit_employee")
                                            <a href="{{route('hr_employees_edit',['id'=>$employee->id])}}"
...
<path
    ...
    fill="currentColor"/>
                                            ...
                                            @can("delete_employee")
                                            <button id="delete_employee_btn_{{$employee->id}}"  onclick="deleteEmployee('{{ $employee->id }}')"
        ...
        function deleteEmployee(id){
                Swal.fire({
                    ...
                    if (result.isConfirmed){
                        window.location.replace("employee/delete/"+id);
                    }
                });
        }
    </script>
