                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                            ...
                            <li class="nav-item">
                                <a class="nav-link fw-bold text-black" data-bs-toggle="tab" href="#re_tab_team">Team</a>
                            </li>

                        </ul>
                        <!--begin::Form-->
                        <form id="re_add_employee_form" name="re_add_employee_form" method="post" class="form"
                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="row mb-7 justify-content-center">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--begin::Input-->
                                                <input type="date" class="form-control form-control-solid"
                                                    name="probation_period_end" id="probation_period_end" value="" />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-7 justify-content-center">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Select2-->
                                                <select class="form-select form-control form-control-solid" name="city"
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--begin::Select2-->
                                                <select class="form-select form-control form-control-solid"
                                                    name="marital_status" id="marital_status" data-control="select2"
                                                    data-placeholder="Select an option">
                                                    <option></option>
                                            ...
                                            <div class="fv-row">
                                                ...
                                                <label class="fs-6 fw-bold form-label">
                                                    <span class="required">Company Email Address</span><i
                                                        class="fas fa-exclamation-circle fs-7" data-bs-toggle="tooltip"
                                                        title="User account will be created on this email address."></i>
                                                </label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                    name="company_email_address" id="company_email_address" value="" />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <input type="time" class="form-control form-control-solid"
                                                    name="duty_start_time" id="duty_start_time" value="" required />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--begin::Input-->
                                                <input type="time" class="form-control form-control-solid"
                                                    name="duty_end_time" id="duty_end_time" value="" required />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-7 d-none" id="contract_div">
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--begin::Input-->
                                                <input type="date" class="form-control form-control-solid"
                                                    name="contract_start_date" id="contract_start_date" value="" />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <div class="col-lg-4 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--begin::Input-->
                                                <input type="date" class="form-control form-control-solid"
                                                    name="contract_end_date" id="contract_end_date" value="" />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <div class="col-lg-4 mb-3">
                                    ...
                                    <div class="row mb-7 justify-content-center">
                                        ...
                                        <div class="col-lg-2 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--begin::Select2-->
                                                <select class="form-select form-control form-control-solid"
                                                    name="account_currency" id="account_currency" data-control="select2"
                                ...
                                <div class="tab-pane fade" id="re_tab_salary" role="tabpanel">
                                    <div class="row mb-7 justify-content-center">
                                ...
                                <div class="tab-pane fade" id="re_tab_user_settings" role="tabpanel">
                                    <div class="row mb-7">
                                        <div class="col-lg-6 col-sm-6 col-md-6 mb-3">
                                            <!--begin::Input group-->
                                            <div class="row">
                                    ...
                                    <div class="row mb-7 d-none" id="user_details_div">
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-md-4 mb-3">
                                            ...
                                            <div class="fv-row">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-bold form-label">
                                                    <span class="">Password </span> <i
                                                        class="fas fa-exclamation-circle fs-7" data-bs-toggle="tooltip"
                                                        title="Leave empty if you want to send user a link to set up password"></i>
                                                </label>
                                                <!--end::Label-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-md-6 mb-3">
                                            <div class="fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Select2-->
                                                <select class="form-select form-control form-control-solid" name="team"
                                                    id="team" data-control="select2"
                                                    data-placeholder="Select an option">
                                                    <option></option>
                                ...
                                <!--begin::Actions-->
                                <button id="re_add_employee_submit" type="submit" class="btn btn-primary float-end">
