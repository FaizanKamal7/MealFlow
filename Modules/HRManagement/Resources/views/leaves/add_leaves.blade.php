...
@section('title', 'HR - Add New Leave')
@section('extra_style')
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form id="re_add_leave_application_form" name="re_add_leave_application_form" method="post"
                                  class="form"
                                  action="{{route("hr_leave_applications_store")}}" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Input group-->
                                ...
                                <div class="row mb-7 justify-content-center">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <div class="fv-row">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-bold form-label">
                                                <span class="required">Impact on Pay(Per Day)</span>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
...
@section('extra_scripts')
    <script src="{{ asset("static/js/custom/apps/hrm/add_leave_application.js") }}"></script>
