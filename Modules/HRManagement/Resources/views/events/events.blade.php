                            ...
                            <table class="table border gy-5 gs-7 table-striped" id="re_event_table">
                                ...
                                @foreach($events as $event)
                                    <tr>
                                        ...
                                        <td><span class="text-white" style="background-color: {{$event->color}}">{{$event->color}}</span></td>
...
<path
    ...
    fill="currentColor"/>
                                            ...
                                            <!--begin::Edit-->
                                            @can("delete_events")
                                            <button id="delete_event_btn_{{$event->id}}"  onclick="deleteEvent('{{ $event->id }}')"
    ...
    <div class="modal fade" tabindex="-1" id="re_add_event_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="re_add_event_form" name="re_add_event_form" method="post"
                      class="form"
                      action="{{route("hr_events_add")}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <!--begin::Actions-->
                        <button id="re_add_event_submit" type="submit"
    ...
    <div class="modal fade" tabindex="-1" id="re_edit_event_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="re_edit_event_form" name="re_edit_event_form" method="post"
                      class="form"
                      action="{{route("hr_events_update")}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row mb-3 justify-content-center">
                            ...
                            <div class="fv-row mb-3">
                                ...
                                <select class="form-select form-control form-control-solid"
                                        ...
                                        data-placeholder="Select an option" id="edit_type">
                                    <option value="Internal">Internal</option>
                                    <option value="External">External</option>
                                    <option value="Private">Private</option>
                                    <option value="Open">Open</option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <!--begin::Actions-->
                        <button id="re_edit_event_submit" type="submit"
                                class="btn btn-primary float-end">
                                             <span class="indicator-label">
                                                    Save Changes
                                                </span>
