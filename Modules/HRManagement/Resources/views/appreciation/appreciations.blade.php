                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$appreciation->employee->first_name ?? ""}} {{$appreciation->employee->last_name ?? ""}}</a>
                                        ...
                                        <td><a class="text-primary" href="{{ asset($appreciation->picture) }}" target="_blank">View</a></td>
                                        <td>
                                            <!--begin::Edit-->
