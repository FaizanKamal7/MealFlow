                                ...
                                @foreach($leave_policy as $policy)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#re_edit_policies_modal"
                                               onclick="editLeavePolicy('{{ $policy->id }}')"
    ...
    <div class="modal fade" tabindex="-1" id="re_edit_policies_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="re_edit_leave_policy_form" name="re_edit_leave_policy_form" method="post"
                      class="form"
                    ...
                    <div class="modal-footer">
                        ...
                        <!--begin::Actions-->
                        <button id="re_edit_leave_policy_submit" type="submit"
