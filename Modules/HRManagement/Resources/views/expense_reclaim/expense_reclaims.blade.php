                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table border gy-5 gs-7" id="re_expense_reclaims_table">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    @if($expenseReclaim->employee->first_name and $expenseReclaim->employee->last_name
                                    and $expenseReclaim->employee->company_email_address != null)
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{$expenseReclaim->employee->first_name}}
                                                {{$expenseReclaim->employee->last_name}}</a>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!--View Invoice -->
                                        <a class="btn btn-icon btn-active-light-info w-30px h-30px"
