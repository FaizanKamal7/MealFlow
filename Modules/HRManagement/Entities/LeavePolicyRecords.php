...
class LeavePolicyRecords extends Model
{
    use HasFactory;
    use HasUuids;
    protected $fillable = [
    ...
    public function leaveApplications(){
        return $this->hasMany(LeaveApplications::class, "leave_policy_record_id");
    }

    protected static function newFactory()
    {
        return \Modules\HRManagement\Database\factories\LeavePolicyRecordsFactory::new();
    }
