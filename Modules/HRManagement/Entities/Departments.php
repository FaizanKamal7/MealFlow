...
class Departments extends Model
{
    ...
    public function departmentEmployees(){
        return $this->hasMany(EmployeeDepartments::class, "department_id");
    }

    public function teams(){
        return $this->hasMany(Teams::class, "department_id");
    }

    protected static function newFactory()
    {
        return \Modules\HRManagement\Database\factories\DepartmentsFactory::new();
    }
