                            ...
                            <div class="current" data-kt-stepper-element="content">
                                ...
                                <div class="w-lg-auto  mx-auto">
                                    ...
                                    <div class="w-lg-700px  mx-auto">
                                        ...
                                        <div class="mb-10 text-center">
                                            <!--begin::Title-->
                                            <h1 style="color:#00426E; font-size:30px" class="mb-3">Create a business
                                                account
                                            </h1>
                                            <!--end::Title-->
                                            <!--begin::Link-->
                                            <div class="text-gray-400 fw-bold fs-4">Already have an account?
                                                <a href="/accounts/login/" class="link-primary fw-bolder">Sign in
                                                    here</a>
                                            </div>
                                            <!--end::Link-->
                                        </div>
                                        ...
                                        <div class="row fv-row">
                                            ...
                                            <div class="col-md-6 fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark fs-6 required">First
                                                    Name</label>
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-md-6 fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark fs-6 required">Last
                                                    Name</label>
                                                <input class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="" data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                                ...
                                                <div class="alert alert-primary d-flex align-items-center p-5">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <li class="d-flex align-items-center py-2">
                                                            <span class="bullet bullet-dot bg-primary me-5"></span><i>
                                                                &nbsp
                                                                You
                                                                can your exact location don't
                                                                show
                                                                up in the search suggestions, search nearest location
                                                                and drap
                                                                and drop
                                                                pic
                                        ...
                                        <p>You can also enter address manually<b>(Not recommended)</b>. If you want to
                                            enter
                                            location manually <a
                                                onclick="toggleLocationDiv()"><code>Click here</code></a>
                                        </p>
                            ...
                            <div class="" data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    <div class="pb-10 pb-lg-15">
                                        ...
                                        <!--end::Title-->
                                        <!--begin::Notice-->
                                        <div class="text-muted fw-bold fs-6">Please add information for your main
                                            business
