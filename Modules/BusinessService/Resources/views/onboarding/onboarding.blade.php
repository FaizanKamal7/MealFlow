                                        ...
                                        <div class="col-xl-4">
                                            <div class="fv-row mb-10">
                                                ...
                                                <select id="address_city" class="form-select form-select-solid"
                                                    ...
                                                    name="address_city" data-allow-clear="true" onchange="fetchAreas()">
                                                    ...
                                                    <div class="form-group row mb-5">
                                                        <div class="col-xl-4">
                                                            ...
                                                            <select
                                                                ...
                                                                data-placeholder="Select an option" name="country_id"
                                                        ...
                                                        <div class="col-xl-4">
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <select
                                                                    ...
                                                                    data-allow-clear="true" name="state_id"
...
<script>
    $('#kt_docs_repeater_advanced').repeater({
        ...
        function fetchingCityByState(selectElement) {
            ...
            console.log('city', stateID, cityDropdown)
        ...
        function FetechingStateDataLocal(selectElement) {
            ...
            // var stateDropdown = $(selectElement).closest('.form-group').find('.state-dropdown')[0];

            // console.log('state first', stateID, cityDropdown)
            ...
            var repeaterItem = $(selectElement).closest('[data-repeater-item]');
            var stateDropdown = repeaterItem.find('.state-dropdown')[0];
            console.log('state', repeaterItem, stateDropdown)
            ...
            console.log('country', countryDropdown, stateDropdown)
            if (selectElement) {
