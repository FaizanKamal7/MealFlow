                    ...
                    <div class="card bg-primary h-md-100">
                        ...
                        <div class="card-body d-flex flex-column pt-13 pb-14">
                            ...
                            <div class="m-0">
                                ...
                                <!--end::Title-->
                                <!--begin::Illustration-->
                                <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 mb-lg-12" style="background-image:url('{{ asset("static/media/svg/illustrations/easy/5.svg") }}')"></div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Links-->
                ...
                <div class="col-xl-4 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="#" class="btn btn-sm btn-light" data-bs-toggle='tooltip' data-bs-dismiss='click' data-bs-custom-class="tooltip-dark" title="Click to view in progress deliveries">View All</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                                        ...
                                        <div class="timeline ms-n1">
                                            ...
                                            <div class="timeline-item align-items-center mb-4">
                                                ...
                                                <div class="timeline-content m-0">
                                                    <!--begin::Label-->
                                                    <span class="fs-8 fw-boldest text-success text-uppercase">Location</span>
                                                    <!--begin::Label-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-6 text-gray-800 fw-bolder d-block text-hover-primary">Logx warehouse</a>
                                                    <!--end::Title-->
                                                    <!--begin::Title-->
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-40px me-3">
                                                    <img src="{{ asset("static/media/avatars/300-2.jpg") }}" class="" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-40px me-3">
                                                    <img src="{{ asset("static/media/avatars/300-12.jpg") }}" class="" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
