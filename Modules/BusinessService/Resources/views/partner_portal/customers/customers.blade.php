                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
...
{{-- <script src="{{ asset('static/js/custom/documentation/general/datatables/subtable.js')}}"></script> --}}
 ...
 <script src="{{ asset('static/js/custom/apps/ecommerce/customers/listing/listing.js')}}"></script>
 <script src="{{ asset('static/js/custom/apps/ecommerce/customers/listing/add.js')}}"></script>
 <script src="{{ asset('static/js/custom/apps/ecommerce/customers/listing/export.js')}}"></script>
