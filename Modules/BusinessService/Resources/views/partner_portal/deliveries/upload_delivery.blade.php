            ...
            <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Form-->
                        <form id="re_add_bulk_form" name="re_add_bulk_form" method="post" class="form" action="#"
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="nixus_modal_upload_excel_form" class="form"
                    action="{{ route('upload_deliveries_by_excel') }}">
                    <!--begin::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div class="input-group mb-5">
                            ...
                            <a href="#" class="input-group-text btn-primary" id="basic-addon2">
