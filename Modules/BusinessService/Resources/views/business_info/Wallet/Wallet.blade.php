        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="main_topup_div mb-5">
                ...
                <div class="d-flex justify-content-between align-items-center current_blnce">
                    ...
                    <div class="d-flex amount_btn">
                        {{-- <a class="btn text-white activate-btn">+ Add Amount</a> --}}
                        <form id="kt_modal_new_card_form" class="d-flex form" action="{{ route('storeCredit') }}" method="POST"
                            data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
                            @csrf
                            <div class="d-flex flex-column me-5 fv-row">
                                <!--begin::Label-->
                            ...
                            <div class="d-flex align-items-end">
                                <button class="btn w-100 text-white activate-btn" type="submit">+ Add Amount </button>
