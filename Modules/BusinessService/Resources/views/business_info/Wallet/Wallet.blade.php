...
@section('title', 'Bussiness | Wallet')
                    ...
                    <div class="card-body d-flex justify-content-between flex-column pt-0 pb-1 px-0">
                        ...
                        <div class="px-9 mb-5">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--end::Currency-->
                                <!--begin::Value-->
                                <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">{{ $wallet->balance ?? ""
                                    }}</span>
                                <!--end::Value-->
                                <!--begin::Label-->
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Annette
                                                Black</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Esther
                                                Howard</a>
                                            <span class="text-muted fw-bold d-block fs-7">Zuid Area</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Guy
                                                Hawkins</a>
                                            <span class="text-muted fw-bold d-block fs-7">Zuid Area</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Marvin
                                                McKinney</a>
                                            <span class="text-muted fw-bold d-block fs-7">Zuid Area</span>
                                        </td>
                                        <td>
