                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                ...
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bolder">Carles
                                        Nilson</a>
                        ...
                        <div class="mb-7">
                            <!--begin::Text-->
                            <div class="text-gray-800 mb-5">Outlines keep you honest. They stop you from indulging in
                                poorly thought-out metaphors about driving and keep you focused on the overall structure
                                of your post</div>
                            <!--end::Text-->
                            <!--begin::Toolbar-->
                            <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="mb-7 ps-10">
                            ...
                            <div class="d-flex mb-5">
                                ...
                                <div class="d-flex flex-column flex-row-fluid">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap mb-1">
                                        <a href="#" class="text-gray-800 text-hover-primary fw-bolder me-2">Alice
                                            Danchik</a>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="d-flex flex-column flex-row-fluid">
                                    <!--begin::Info-->
                                    <div class="d-flex align-items-center flex-wrap mb-1">
                                        <a href="#" class="text-gray-800 text-hover-primary fw-bolder me-2">Harris
                                            Bold</a>
                                    ...
                                    <span class="text-gray-800 fs-7 fw-normal pt-1">Outlines keep you honest. They stop
                                        you from indulging in poorly</span>
                                    <!--end::Post-->
                                </div>
                                <!--end::Info-->
                            </div>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                ...
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder">Carles
                                        Nilson</a>
                                    <span class="text-gray-400 fw-bold">Last week at 10:00 PM</span>
                                </div>
                                <!--end::Info-->
