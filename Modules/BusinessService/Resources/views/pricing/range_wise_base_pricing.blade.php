                        ...
                        <table class="table border gy-5 gs-7" id="re_team_table">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>{{$pricing->delivery_price}} ({{$pricing->same_loc_delivery_price}}) {{$pricing->city->state->country->currency}}</td>
                                    <td>{{$pricing->bag_collection_price}} ({{$pricing->same_loc_bag_collection_price}}) {{$pricing->city->state->country->currency}}</td>
                                    <td>{{$pricing->cash_collection_price}} ({{$pricing->same_loc_bag_collection_price}}) {{$pricing->city->state->country->currency}}</td>
