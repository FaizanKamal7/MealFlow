			...
			<div class="card card-flush">
				...
				<div class="card-header mt-6">
					...
					<div class="card-title">
						<!--begin::Search-->
						<h3 class="modal-title">Location Pricing Info</h3>
						<!--end::Search-->
					</div>
					<!--end::Card title-->
					<!--start::Card Tool Bar-->
					...
					<table class="table border gy-5 gs-7" id="re_team_table">
						...
						<thead class="bg-light-dark">
							...
							<tr class="text-start fw-bolder fs-7 text-uppercase gs-0">
								...
								<th class="min-w-1px">Price (Per delivery)</th>
						...
						<tbody class="fw-bold text-gray-600">
							<tr>
								<td>Dubai (UAE)</td>
								<td>02:00 - 04:00 am</td>
								<td> 3$</td>
								<td>Active</td>
								<td>12:45 pm (19-07-2023)</td>
								<td>
									<!--begin::Members-->
