...
<script>
    ...
    document.getElementById('base_range_pricing_form').addEventListener('submit', function(e) {
        e.preventDefault();
        let formData = new FormData(e.target);
        for (let pair of formData.entries()) {
            console.log(pair[0]+ ', '+ pair[1]); 
        }
        e.target.submit(); // Uncomment this line to allow the form to be submitted after you've checked the data.
    });
</script>
@endpush