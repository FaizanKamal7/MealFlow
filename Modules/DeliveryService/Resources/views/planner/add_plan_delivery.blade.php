        ...
        <div class="">
            ...
            <div class="mt-2 form-generate-div">
                ...
                <div class="form-group row my-10">
                    <div class="col-md-3">
                        <input type="hidden" name="selected_skip_days" id="selected_skip_days">
            ...
            <div id="meal-planner-form-id" style="display: none">
                @livewire('deliveryservice::meal-planner-form', ['customer_addresses' => $customer_addresses,
                'product_type' => $product_type, 'branches' => $branches])
            </div>
        </div>
    </div>
    <!--end::Container-->
...
<script>
    $(document).ready(function() {
        ...
        function generatePlan() {
            ...
            document.getElementById('selected_skip_days').value = skipDays ;
        ...
        function invokeForm(expiry_date, start_date, included_dates, no_of_days) {
            skip_days = document.getElementById('skipdays').value; 
