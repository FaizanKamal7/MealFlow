        ...
        function get_record() {    
            ...
            $.ajax({
                url: customerUrl,
                    ...
                    success: function(customer_meal_plans) {
                        console.log(customer_meal_plans);
                        console.log(typeof(customer_meal_plans));
                        
                        var form_component = document.getElementById("plan_report_id");
                        form_component.style.display = "block";
                        var component_id = document.querySelector('#plan_report_id [wire\\:id]').getAttribute('wire:id');
                        
                        var component = Livewire.find(component_id);
                        component.set('customer_meal_plans', customer_meal_plans); 
