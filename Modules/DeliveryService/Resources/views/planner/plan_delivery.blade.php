                ...
                <div class="d-flex align-items-center business-second">
                    <div class="me-3">
                        <select id="business" name="business" class="form-select form-select-solid"
                            ...
                            <option value="{{ $business->id }}" data-business-object="{{ json_encode($business) }}">{{ $business->name }}</option>
...
@section('extra_scripts')
    ...
    <script>
        ...
        function getBusinessCustomers() {
            ...
            const business = JSON.parse(selectedOption.getAttribute('data-business'));
            console.log(business);
            console.log(typeof(business));
            console.log(business.businessCustomers);
