    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="d-flex main-div-container col-xl-12">
                <div class="pickup-batch-div col-5 col-xl-5">
                        ...
                        <div class="tab-view tab-content" id="myTabContent">
                            <div class="tab-pane fade show active d-flex flex-column" id="kt_tab_pane_1" role="tabpanel">
                                <div class="d-flex batch-row">
                                    <div class="id-div">
                                        <p class="delivery-id">ID # 127</p>
                                        <p class="delivery-time">12:09 am</p>
                                    </div>
                                    <div class="driver-name-div">
                                        <p class="driver-name">Driver Name</p>
                                        <p class="vehicle-number">Vehicle # AHR 3478</p>
                                    </div>
                                    ...
                                    <div class="progress-div">
                                        ...
                                        <div class="d-flex align-items-center ">
                                            <div class="d-flex align-items-center w-100 justify-content-between mb-3">
                                                <span class="rate fw-bolder">29/65</span>
                                                <span class="text-black-700 opacity-75 fw-bolder">Time Left 4h
                                                    26m</span>
                                            </div>
                                            <!--end::Section-->
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center w-100">
                                            ...
                                            <div class="progress h-6px w-100 ">
                                                <div class="progress-bar" role="progressbar"
                                                    style="width: 58%; background: rgba(0, 66, 110, 1);" aria-valuenow="65"
