                ...
                <div class="card card-flush ">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-gray-800">Delivery History</span>
                            ...
                            <div class="" id="kt_list_widget_10_tab_1">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-sm-center pb-15">
                                        ...
                                        <div class="me-7 mb-4">
                                            <div
                                                ...
                                                {{-- <img src="{{ asset($delivery_timeline[0]->qr_code) }}"
                                                    alt="image" /> --}}
                                                <div
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            <div class="flex-grow-1 ">
                                                <span class="text-gray-800 fw-bolder d-block fs-6">Partner</span>
                                                <a href="#"
                                                    class="text-gray-400 fs-1x fw-bold">{{$delivery_timeline[0]->delivery->branch->business->name}}</a>
                                        ...
                                        <div class="me-2 mb-4 ps-10">
                                            <div class="flex-grow-1 ">
                                                <span class="text-gray-800 fw-bolder d-block fs-6">Customer</span>
                                                <span href="#"
                                                    class="text-gray-400 fs-1x d-block fw-bold">{{$delivery_timeline[0]->delivery->customer->user->name
                                                    }}</span>
                                                <span href="#"
                                                    class="text-gray-400 fs-1x d-block fw-bold">{{$delivery_timeline[0]->delivery->customer->user->phone}}</span>
                                    ...
                                    <div class=" d-flex justify-content-center mb-7 ">
                                        <div class=" me-2">
                                            {{-- <span class="text-gray-500 fw-bolder fs-1x">60 km\h -> 51.3 km\h
                                            </span> <span class="text-gray-500 fw-bolder fs-1x ps-">.58 mins</span> --}}
                                    ...
                                    <div class="timeline-label">
                                        ...
                                        <div class="timeline-item mb-15 mt-5">
                                            ...
                                            <div class="timeline-content d-flex">
                                                <span class="fw-bolder text-gray-800 ps-3">{{$timeline->status}}
                                                </span>
                                                <br>
                                                @if ($timeline->action_by)
                                                ({{$timeline->action_by}})
                                                @endif
