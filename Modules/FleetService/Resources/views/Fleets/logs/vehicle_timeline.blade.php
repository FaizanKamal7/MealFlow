...
@section('title', ' Vehicle Timeline')
                    ...
                    <div class="card card-flush ">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800">Vehicle Timeline</span>
                            ...
                            <div class="card-toolbar">
                                <div>
                                    <select class="form-select form-control form-control" name="vehicle_make"
                                        id="vehicle_make" data-control="select2" data-placeholder="Select an option">
                                        <option value="">Select Vehicle</option>
                                        @foreach ($vehicles as $vehicle)
                                            <option value="{{ $vehicle->id }}"
                                                {{ old('vehicle_make') == $vehicle ? 'selected' : '' }}>
                                                {{ ucfirst($vehicle->vehicleModel->make) }}-{{ ucfirst($vehicle->vehicleModel->model) }}-{{ $vehicle->registration_number }}</option>
                                        @endforeach
                                    </select>
                                    @error('vehicle')
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                <div class="flex-grow-1 me-2">
                                                    ...
                                                    <div class="badge badge-lg badge-light-success fw-bolder"
                                                        ...
                                                        title="Model : AGZ5161<br>Registration N0 : JAKSHSA67<br>Owner : Ali Ahmed <br>Engine :1817CC Turbo">
                                                        Honda</div>
                                        ...
                                        <div id="kt_customer_view_details" class="collapse hide">
                                            <div class="timeline-label">
                                                ...
                                                <div class="timeline-item mb-15">
                                                    ...
                                                    <!--end::Badge-->
                                                    <!--begin::Desc-->
                                                    <div class="timeline-content fw-bolder text-gray-800 ps-3">End Timing
                                                    </div>
