		...
		<div class="card mb-5 mb-xl-10">
			<div class="card-body pt-9 pb-0">
						...
						<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
							...
							<div class="d-flex flex-column">
								...
								<div class="d-flex align-items-center mb-2">
									<a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$driver->employee->first_name}} {{$driver->employee->last_name}}</a>
									<a href="#">
								...
								<div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
									<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
										...
										<!--end::Svg Icon-->{{$driver->employee->designation->name}}</a>
									<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
										...
										<!--end::Svg Icon-->{{$driver->employee->city}},{{$driver->employee->country}}</a>
									<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
										...
										<!--end::Svg Icon-->{{$driver->employee->personal_email_address}}</a>
								</div>
								<!--end::Info-->
							</div>
							<!--end::User-->
								...
								<div class="d-flex flex-wrap">
									...
									<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
										...
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{   $driver->employee->employeeSalary }}" data-kt-countup-prefix="$">0</div>
										</div>
										<!--end::Number-->
										<!--begin::Label-->
				...
				<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
					...
					<!--begin::Nav item-->
					<li class="nav-item mt-2">
						<a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{route("fleet_view_driver_timeline",['driver_id'=>$driver->id])}}">Logs</a>
					</li>
					<!--end::Nav item-->
				</ul>
				<!--begin::Navs-->
					...
					<table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
						...
						<tbody class="fw-6 fw-bold text-gray-600">
							...
							<tr>
								...
								<td>
									<span class=" fs-7 fw-bolder text text-gray-800">{{$driver->employee->first_name}} {{$driver->employee->last_name}}</span>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<span class=" fs-7 fw-bolder text text-gray-800">
										{{$driver->licence_Document?$driver->licence_Document:"Not Available"}}</span>
								</td>
								<td>
									<span class=" fs-7 fw-bolder text text-gray-800"></span>
								</td>
	...
	<div class="modal-dialog modal-dialog-centered mw-750px ">
		...
		<div class="modal-content rounded  ">
			...
			<div class="modal-body  pt-0 ">
				<!--begin:Form-->
				<form class="form" action="{{route('fleet_update_driver_detail',['driver_id'=>$driver->id])}}" id="KTModalDriver_form" method="POST" enctype="multipart/form-data">
					@csrf
                    <!--begin::Modal header-->
						...
						<div class="scroll-y me-n7 pe-7" id="KTModalDriver_scroll"  data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#KTModalDriver_header" data-kt-scroll-wrappers="#KTModalDriver_scroll" data-kt-scroll-offset="300px">
							...
							<div class="row g-9 mb-10">
								...
								<div class="col-md-6 fv-row">
									...
									<!--end::Label-->
									<input type="text" class="form-control form-control-solid" placeholder="Enter Licence Number" name="Driver_Licence_number" value="{{$driver->license_number}}"/>
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-md-6 fv-row">
									...
									<!--end::Label-->
									<input type="file" class="form-control form-control-solid" placeholder="Enter Licence Document" name="Driver_Licence_Document" />
								</div>
								<!--end::Col-->
							</div>
							<!--end::Input group-->
							...
							<div class="row g-9 mb-10">
                                ...
                                <div class="col-md-6 fv-row">
									<label class="required fs-6 fw-bold mb-2">Licence Start Date</label>
									<!--begin::Input-->
									<div class="position-relative d-flex align-items-center">

										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Select a date" name="Driver_licence_issue_Date" type="date" value="{{$driver->license_issue_date}}" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Select a date" name="Driver_licence_expiry_Date" type="date" value="{{$driver->license_expiry_date}}" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="me-5">
									...
									<span>
										...
										<label class="form-check form-switch form-check-custom form-check-solid">
											<input class="form-check-input mx-4" type="checkbox" name="is_available"  {{$driver->is_available? "checked":""}} /><span class="fs-6 fw-bold">Is Available</span>
