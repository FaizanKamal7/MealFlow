                                    ...
                                    @foreach ($drivers as $driver)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3 ">
                                                        <img src="{{ asset('static/media/avatars/300-1.jpg') }}"
                                                            class="" alt="" />
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="{{ route('fleet_view_driver_detail', ['driver_id' => $driver->id]) }}"
                                                            class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">{{ $driver->employee->first_name }}
                                                            {{ $driver->employee->last_name }}</a>
                                                        <span
                                                            class="text-gray-400 fw-bold d-block fs-7">{{ $driver->employee->personal_email_address }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                {{ $driver->licence_Document ? $driver->licence_Document : 'Not Available' }}
                                            </td>
                                ...
                                <div class="row g-9 mb-10">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        . <input type="text" class="form-control form-control-solid"
                                            placeholder="Enter Licence Number" name="licence_number" />
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="file" class="form-control form-control-solid"
                                            placeholder="Enter Licence Document" name="licence_Document" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row g-9 mb-10">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <input class="form-control form-control-solid ps-12"
                                                placeholder="Select a date" name="licence_issue_Date" type="date" />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--begin::Datepicker-->
                                            <input class="form-control form-control-solid ps-12"
                                                placeholder="Select a date" name="licence_expiry_Date" type="date" />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                        ...
                                        <span>
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input mx-4" type="checkbox" value="1"
                                                    name="is_available" checked="checked" /><span class="fs-6 fw-bold">Is
                                                    Available</span>
