                                ...
                                <div class="row g-9 mb-10">
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <input class="form-control form-control-solid ps-12"
                                                placeholder="Select a date" name="license_issue_Date" type="date"
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--begin::Datepicker-->
                                            <input class="form-control form-control-solid ps-12"
                                                placeholder="Select a date" name="license_expiry_Date" type="date"
                                        ...
                                        <span>
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input mx-4" type="checkbox" value="1"
                                                    name="is_available" checked="checked"
                                                    @if (old('is_available')) selected @endif /><span
                                                    class="fs-6 fw-bold">Is
                                                    Available</span>
                                            </label>
                                        </span>
                                    </div>
