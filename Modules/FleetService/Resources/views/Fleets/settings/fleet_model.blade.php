                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <button
                                    ...
                                    data-bs-target="#nixus_update_vehicle_model">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                 data-kt-models-modal-action="close">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form id="nixus_add_vehicle_model_form" class="form" action="#">
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <input class="form-control form-control-solid"
                                           placeholder="Enter Vehicle Model" name="model_name"/>
                                    <!--end::Input-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <!--end::Notice-->
                            <!--begin::Form-->
                            <form id="nixus_update_vehicle_model_form" class="form" action="#">
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold form-label mb-5 mx-2">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid"
                                           placeholder="Enter a  Model Name" name="model_name"/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
