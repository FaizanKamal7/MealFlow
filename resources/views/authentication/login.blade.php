                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        ...
                        <a href="#" class="py-9 mb-5">
                            <img alt="Logo" src="{{ asset('static/media\logos\logo_dark_horizontal.png')}}" class="h-60px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        ...
                        <p class="fw-bold fs-2" style="color: #986923;">One stop solution
                            <br />for all your logistics needs</p>
                        <!--end::Description-->
                    </div>
                    <!--end::Content-->
                    <!--begin::Illustration-->
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url({{ asset("static/media/illustrations/sketchy-1/13.png") }})"></div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
            </div>
