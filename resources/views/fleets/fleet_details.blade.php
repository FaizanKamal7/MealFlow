...
@section('title', 'Fleets Dashboard')
                            ...
                            <div class="col-7 ps-xl-13">
                                ...
                                <div class="d-flex gap-7 align-items-center">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        <!--begin::Name-->
                                        <div class="fs-4 fw-bold me-2 d-block lh-1 pb-2 opacity-75 text-white ">Occupied
                                            By
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="#"
                                               class="fs-4 fw-bold me-2 d-block lh-1 pb-2 opacity-75 text-white">+6141
                                                234
                                                567</a>
                                        </div>
                                        <!--end::Phone-->
                                ...
                                <div class="row mt-15">
                                    <div class="card-Fluid   rounded-pill " style="background-color:  #1639cf5e">
                                        <div class="px-10 py-5">
                                            ...
                                            <div class="fs-4 fw-bold text-white ">Temperature:<span class="fs-2qx">
                                                7*C</span>
                                            </div>
                                        </div>
                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <div class=" card h-md-100 ">
                            ...
                            <img src="{{asset('static/media/Fleet/fleet.jpg')}}" class=""
                                 alt=""/>
                        </div>
                    </div>
                    <!--end::Tables Widget 9-->
