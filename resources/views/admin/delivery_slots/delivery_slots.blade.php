                        ...
                        <table class="table border gy-5 gs-7" id="re_team_table">
                            ...
                            <thead class="bg-light-dark">
                                ...
                                <tr class="text-start fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-1px">Start Time</th>
                                    <th class="min-w-1px">End Time</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    <td>{{$delivery_slot->city->name}}</td>
                                    <td>{{$delivery_slot->start_time }}</td>
                                    <td>{{$delivery_slot->end_time}}</td>
                                    <td>{{$delivery_slot->active_status == 1 ? "Active" :"Inactive" }}</td>
                                    <td>{{$delivery_slot->created_at}}</td>
                                    <td>
                                        <!--begin::Members-->
                                        ...
                                        <!--end::Edit-->
                                        <!--begin::Delete-->
                                        <a id="delete_team_btn_{{ $delivery_slot->id }}" onclick=""
