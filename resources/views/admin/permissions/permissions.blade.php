            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            <!--begin::Name=-->
                            <td>{{ $permission->name }} <span class="badge badge-light-primary fs-7 m-1">{{
                                    $permission->codename }}</span>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Assigned to=-->
                            <td>
                                @foreach($permission->permissionRoles as $role)
                                <a href="#" class="badge badge-light-success fs-7 m-1"> {{ $role->role->role_name }}</a>
                                @endforeach
                            </td>
                            <!--end::Assigned to=-->
                            <!--begin::Created Date-->
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_add_permission_form" method="post" class="form" action="{{ route("
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Enter a permission codename"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <label class="form-check form-check-custom form-check-solid me-9">
                                    ...
                                    <span class="form-check-label" for="kt_permissions_status">Active ?</span>
                                </label>
                                <!--end::Checkbox-->
                            </div>
                            <!--end::Input group-->
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_update_permission_form" method="post" class="form" action="{{ route("
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Enter a permission name"
                                    id="permission_name_update" name="permission_name" />
                                <input class="form-control form-control-solid" id="permission_id" name="permission_id"
                                    hidden />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Checkbox-->
                                <label class="form-check form-check-custom form-check-solid me-9">
                                    <input class="form-check-input" type="checkbox" name="permission_status_update"
                                        id="kt_permissions_status_update" />
                                    <span class="form-check-label" for="kt_permissions_status_update">Active ?</span>
                                </label>
                                <!--end::Checkbox-->
                            </div>
                            <!--end::Input group-->
