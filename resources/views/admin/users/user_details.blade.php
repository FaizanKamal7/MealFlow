                                ...
                                <div class="card-body py-0">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5"
                                        ...
                                        <tr>
                                            <!--begin::Event=-->
                                            <td class="min-w-400px">Invoice
                                                <a href="#" class="fw-bolder text-gray-900 text-hover-primary me-1">#KIO-45656</a>status
                                                has changed from
                                        ...
                                        @foreach($roles as $role)
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    <!--begin::Input-->
                                                    <input class="form-check-input me-3" name="user_roles[]"
                                                           type="checkbox"
                                                    ...
                                                    <label class="form-check-label"
                                                        ...
                                                        <div
                                                            class="fw-bolder text-gray-800">{{ $role->role_name }}</div>
                                                        <div class="text-gray-600">
                                                            {{ $role->description }}
                                                        </div>
                                                    </label>
