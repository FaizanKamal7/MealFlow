                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="badge badge-light-primary fs-7 m-1">{{
                                    $permission->permission->codename }}</a>
                                @endforeach
                            </td>
                            <!--end::Permissions=-->
                            <!--begin::Assigned to=-->
                            <td>
                                ...
                                <a href="#" class="badge badge-light-primary fs-7 m-1">{{ $user->user->name }} {{
                                    empty($role->roleUsers) }}</a>
                                @endforeach
                                @else
                                <a href="#" class=" fs-7 m-1">Not Assigned Yet</a>
                                @endif
                            </td>
                            <!--end::Assigned to=-->
                            <!--begin::Created Date-->
            ...
            <div class="modal-dialog modal-dialog-centered mw-950px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-lg-5 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_add_role_form" class="form" method="post" action="{{ route('role_store') }}">
                            @csrf
                            <!--begin::Scroll-->
